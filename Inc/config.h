...
#define PWM_FREQ         16000      // PWM frequency in Hz(16kHz)
...
#define BAT_CALIB_REAL_VOLTAGE        28.0       // input voltage measured by multimeter  
#define BAT_CALIB_ADC                 1654       // adc-value measured by mainboard (value nr 5 on UART debug output)

#define BAT_NUMBER_OF_CELLS     7        // normal Hoverboard battery: 7s
